...
// interface RoboticsSimulationPageProps {
//   onNavigate?: (page: string) => void;
// }

// export function RoboticsSimulationPage({ onNavigate }: RoboticsSimulationPageProps) {
...
//                   {[
//                     {
//                       value: 'item-1', title: 'Introduction to Robotics',
...
//                     },
//                     {
//                       value: 'item-10', title: 'Final Project',
//                       items: ['Complete automation system design', 'Full simulation and validation', 'Technical documentation', 'Portfolio presentation']
//                     },
//                   ].map((section) => (
//                     <AccordionItem key={section.value} value={section.value} className="border-none">
//                       <AccordionTrigger

...
interface Industry4PageProps {
  onNavigate?: (page: string) => void;
}

export function Industry4Page({ onNavigate }: Industry4PageProps) {
  return (
    <>
      {/* Hero Section */}
      <section
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-8">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-[12px] lg:justify-start justify-center">
                <button onClick={() => onNavigate?.('contact')} className="bg-black box-border content-stretch flex items-center justify-center overflow-clip px-[38px] py-[20px] relative rounded-[9999px] shrink-0 w-full sm:w-auto hover:opacity-90 transition-opacity">
                ...
                <button onClick={() => onNavigate?.('contact')} className="backdrop-blur backdrop-filter bg-[rgba(255,255,255,0.1)] box-border content-stretch flex items-center justify-center px-[28px] py-[20px] relative rounded-[9999px] w-full sm:w-auto hover:bg-[rgba(255,255,255,0.15)] transition-colors">

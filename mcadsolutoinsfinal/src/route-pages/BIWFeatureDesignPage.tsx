          ...
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-8">
            ...
            <div className="space-y-6">
              ...
              >
                <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[16px] z-10" />
                <div className="relative aspect-video">
                  <img src={imgVideo1} alt="Course Preview" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-[60px] h-[60px] rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(249,168,37,0.9)' }}>
              ...
              >
                <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[16px] z-10" />
                <img
                  src="https://images.unsplash.com/photo-1754878206374-f78eac63ff29?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB0cmFpbmluZyUyMGZhY2lsaXR5fGVufDF8fHx8MTc2MTMxMjg5N3ww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Training Facility"
                  className="w-full h-[200px] object-cover"
                />
              </div>

            ...
            <div className="content-stretch flex flex-col-reverse lg:flex-row gap-8 md:gap-[40px] items-center justify-center w-full">
              ...
              >
                ...
                <div className="flex flex-col font-bold text-gray-100">
                  <p className="text-[28px] md:text-[44px] lg:text-[56px] leading-[34px] md:leading-[52px] lg:leading-[64px] tracking-[-0.5px]">
                    Your Path from CAD To
                  </p>
                  <p className="text-[28px] md:text-[44px] lg:text-[56px] leading-[34px] md:leading-[52px] lg:leading-[64px] tracking-[-0.5px]">
                    to Smart Automotive Engineering
                  </p>
                </div>
                ...
                <div className="max-w-full lg:max-w-[576px] pt-[8px]">
                  <p className="text-gray-300 text-[16px] md:text-[20px] lg:text-[24px] leading-[24px] md:leading-[28px] lg:leading-[32px]">
                    Master CAD to Domain Expertise at M CAD Solutions
      ...
      >
        <div className="max-w-[1280px] mx-auto px-[16px] md:px-[32px]">
          <AnimatedSection className="text-center mb-[32px] md:mb-[48px]">
            ...
            >
              <p>
                From 3D modeling to industrial design — choose the course
        ...
        <div className="max-w-[1280px] mx-auto px-[16px] md:px-[32px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] md:gap-[24px]">
            ...
            <div className="backdrop-blur-md backdrop-filter flex flex-col gap-[16px] p-[20px] md:p-[25px] relative rounded-[16px]">
              <div className="absolute border-2 border-[rgba(255,255,255,0.3)] inset-0 pointer-events-none rounded-[16px]" />
              ...
              <div>
                <h3 className="text-[18px] mb-[8px]" style={{ color: "#F4F7F9" }}>
                  Industry Expertise
                </h3>
                <p
            ...
            <div className="flex-1 content-stretch flex flex-col gap-[20px] md:gap-[24px] items-start relative">
              ...
              >
                <p className="leading-[34px] md:leading-[42px] lg:leading-[48px]">
                  Be the Engineer Who Designs the Product of the Future
                </p>
              </div>
              <div
              ...
              <div className="box-border content-stretch flex flex-col sm:flex-row gap-[12px] items-start pt-[16px] relative w-full">
                <Link
                  href="/contact"
                  className="bg-gradient-to-r from-[#10162F] to-[#FBBF24] box-border content-stretch flex items-center justify-center overflow-clip px-[32px] md:px-[42px] py-[18px] md:py-[22px] relative rounded-[9999px] shrink-0 w-full sm:w-auto"
                >
                  <div
        ...
        <div className="max-w-[1280px] mx-auto px-[16px] md:px-[32px]">
          <div className="flex flex-col lg:flex-row gap-[32px] lg:gap-[48px] items-start">
            ...
            <div className="flex-1 backdrop-blur-md backdrop-filter box-border content-stretch flex flex-col gap-[20px] md:gap-[24px] items-start p-[24px] md:p-[32px] lg:p-[40px] relative rounded-[16px]">
              ...
              >
                <p>
                  At M CAD Solutions, we don’t just train students—we prepare industry-ready engineers and design professionals for the automotive and manufacturing sectors. Our programs cover leading tools like CATIA V5, SolidWorks, UG NX, BIW Fixture Design, Automotive Interior Trim Design, and Robotics Simulation, giving students practical skills aligned with real industry requirements.

With award-winning expertise, and a strong placement record, we provide a complete learning ecosystem that bridges the gap between academics and real-world engineering. Our goal is to help students build strong technical foundations, confidence, and career-ready portfolios for success in modern engineering environments.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="backdrop-blur-md backdrop-filter box-border content-stretch flex flex-col relative rounded-[16px] overflow-hidden">
              ...
              <div className="flex flex-col gap-[14px] md:gap-[16px] p-[20px] md:p-[24px]">
                ...
                <div className="flex flex-col gap-[12px] mt-[8px]">
                  <Link
                    href="/biw-fixture-design"
                    className="w-full bg-gradient-to-r from-[#10162F] to-[#FBBF24] px-[24px] py-[12px] rounded-[9999px] text-center"
                    style={{ color: "#F4F7F9" }}
                  >
                    Enroll Course
                  </Link>
                  <Link
                    href="/contact"
                    className="w-full backdrop-blur backdrop-filter bg-[rgba(255,255,255,0.1)] box-border px-[24px] py-[12px] rounded-[9999px] border border-[rgba(255,255,255,0.1)] text-center"
                    style={{ color: "#F4F7F9" }}
                  >
                    Book Free Demo
                  </Link>
      ...
      {/* Footer spacer for visual separation */}
